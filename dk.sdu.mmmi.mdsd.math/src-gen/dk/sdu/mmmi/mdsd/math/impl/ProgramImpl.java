 ...
 *   <li>{@link dk.sdu.mmmi.mdsd.math.impl.ProgramImpl#getExt <em>Ext</em>}</li>
...
public class ProgramImpl extends MinimalEObjectImpl.Container implements Program
{
   ...
   * @ordered
   */
  protected EList<Expression> ext;
   ...
   */
  @Override
  public EList<Expression> getExt()
  {
    if (ext == null)
    {
      ext = new EObjectContainmentEList<Expression>(Expression.class, this, MathPackage.PROGRAM__EXT);
    }
    return ext;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case MathPackage.PROGRAM__EXT:
        getExt().clear();
        getExt().addAll((Collection<? extends Expression>)newValue);
        return;
      case MathPackage.PROGRAM__MATH:
