 ...
 *   <li>{@link dk.sdu.mmmi.mdsd.math.impl.ExternalUseImpl#getParams <em>Params</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExternalUseImpl extends ExpressionImpl implements ExternalUse
{
  ...
  public EList<Expression> getParams()
  {
    if (params == null)
    {
      params = new EObjectContainmentEList<Expression>(Expression.class, this, MathPackage.EXTERNAL_USE__PARAMS);
    }
    return params;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MathPackage.EXTERNAL_USE__PARAMS:
